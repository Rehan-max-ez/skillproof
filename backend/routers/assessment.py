...
def generate_question(
    ...
    with Session(engine) as db:
        ...
        try:
            parsed = generate_first_question(session.skill)
        ...
        new_question = Question(
            ...
            examples_json=parsed.get("examples") or [],
            difficulty="medium",
        )
        ...
        return {
            ...
            "examples": new_question.examples_json or [],
    ...
    with Session(engine) as db:
        ...
        try:
            if is_final_question:
                ...
                force_type = None
                if current_question_index == MAX_QUESTIONS_PER_SESSION - 1 and len(existing_questions) >= 2:
                    types = [q.question_type for q in existing_questions]
                    if all(t == "coding" for t in types):
                        force_type = "theory"
                    elif all(t == "theory" for t in types):
                        force_type = "coding"
                ...
                ai_result = evaluate_and_generate_next(
                    ...
                    force_question_type=force_type,
                )
        ...
        next_question = Question(
            ...
            examples_json=ai_result.get("next_question_examples") or [],
        ...
        return {
            ...
            "next_question": {
                ...
                "examples": next_question.examples_json or [],
...
def get_next_question(session_id: int):
    with Session(engine) as db:
        ...
        return {
            ...
            "examples": latest_question.examples_json or [],
